...
class channelThermalNoiseAdder:
    ...
    elements from both Masha and Steffen's code are included
    """
    ...
    def begin(self, dtheta=5*units.degrees, noise_temperature=300*units.kelvin):
        """
...
#                                                                                   *antenna_orientation)
                ...
                antenna_response = self.get_cached_antenna_response(antenna_pattern, zenith, azimuth,
                                                                    *antenna_orientation)
