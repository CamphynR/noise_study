...
#python plotting_scripts/plot_average_ft.py -d  /pnfs/iihe/rno-g/store/user/rcamphyn/noise_study/data/average_ft/job_2025_05_22_v3/station${STATION}/clean/average_ft_combined.pickle \
# -s /pnfs/iihe/rno-g/store/user/rcamphyn/noise_study/simulations/average_ft/job_2025_05_23_ice/station${STATION}/clean/average_ft.pickle \
#  /pnfs/iihe/rno-g/store/user/rcamphyn/noise_study/simulations/average_ft/job_2025_05_23_electronic/station${STATION}/clean/average_ft.pickle \
#  /pnfs/iihe/rno-g/store/user/rcamphyn/noise_study/simulations/average_ft/job_2025_05_23_galactic/station${STATION}/clean/average_ft.pickle
