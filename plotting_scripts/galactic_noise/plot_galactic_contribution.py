...
def sim_with_weight(sim, calibration, channel_ids=np.arange(24)):
    ...
    return sim_spectra, electronic_spectra, galactic_spectrum
...
def sim_no_weight(sim, calibration, channel_ids=np.arange(24)):
    ...
    return sim_spectra, electronic_spectra, galactic_spectra
...
if __name__ == "__main__":
    ...
    sim_measured_electronic_noise_weight, sim_measured_electronic_noise_weight_electronic_comp, sim_galaxy_weight = sim_with_weight(
            sim_measured_electronic_noise,
            calibration["default"],
            channel_ids=channel_ids)


    sim_measured_electronic_noise_no_weight, sim_measured_electronic_noise_no_weight_electronic_comp, sim_galaxy_no_weight = sim_no_weight(
            sim_measured_electronic_noise,
