...
#    bandpass = [0.05, 0.2]
    ...
    pdf = PdfPages(f"figures/paper/spectra_fit_season{season}_st{station_id}.pdf") 
...
#    fig.suptitle(f"Calibration results", size=62)
    ...
    plt.savefig(f"figures/paper/spectra_fit_season{season}_st{station_id}_pos.pdf", bbox_inches="tight") 
...
#    fig.suptitle(f"Station {station_id}")
    fig.tight_layout()
    fig.savefig(f"figures/paper/gain_per_channel_season{season}_st{station_id}") 
