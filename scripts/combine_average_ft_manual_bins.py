...
if __name__ == "__main__":
    ...
    parser.add_argument("--runs_per_bin", type=int)
    ...
    for i, pickle in enumerate(args.pickles[1:]):
        ...
        if nr_runs >= args.runs_per_bin:
            print("New bin, saving \n ----------")
            bin_nr += 1
            nr_runs = 0
            ...
            just_switched_bin = True

            pickle_file = args.pickles[0].rsplit("_", 1)[0]
            pickle_file += f"_bin{bin_nr}_combined.pickle"
